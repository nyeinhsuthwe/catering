...
const Password = () => {
  ...
  return (
    <div className="">
      ...
      <p className="mx-auto dark:text-yellow-500 text-yellow-400 max-w-lg  text-2xl mb-4 font-bold  mt-[80px]">
      ...
      <Card className="max-w-lg mx-auto">
        ...
        >
          ...
          <Button
            className="mt-3 w-[200px] bg-yellow-400 dark:bg-yellow-500 hover:bg-yellow-500 dark:hover:bg-yellow-400"
            type="submit"
          >
